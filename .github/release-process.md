...
4. Let [`.github/workflows/release-sdk.yml`](/home/dev/mrs-sdk-flutter/.github/workflows/release-sdk.yml) create and push tag `vX.Y.Z` from the merged commit.
...
Automated by CI/CD in [`.github/workflows/release-sdk.yml`](/home/dev/mrs-sdk-flutter/.github/workflows/release-sdk.yml):
...
3. Merge the pull request into `main`.
4. Let [`.github/workflows/release-lints.yml`](/home/dev/mrs-sdk-flutter/.github/workflows/release-lints.yml) create and push tag `lints-vX.Y.Z` from the merged commit.
...
Automated by CI/CD in [`.github/workflows/release-lints.yml`](/home/dev/mrs-sdk-flutter/.github/workflows/release-lints.yml):
